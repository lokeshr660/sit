...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) {
    ...
    g.VERSION = "3.4.1", g.prototype.toggle = function(d) {
        var e = a(this);
    ...
    a.PT_CV_Public = function(b) {
        ...
        _update_url: function(a) {
            ...
            if (!PT_CV_PUBLIC.is_admin && !window.cv_pagination_no_update_url) {
                var c = !1;
                c = a > 1 ? b._get_paginated_url(a) : PT_CV_PAGINATION.links && PT_CV_PAGINATION.links.page_1, c && history.replaceState(null, null, encodeURI(c))
            }
        }
    }, a(function() {
        new a.PT_CV_Public
