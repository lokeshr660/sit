...
WONDERPLUGIN_SLIDER_SKIN_OPTIONS.lefttabs = {};
for (var key in WONDERPLUGIN_SLIDER_SKIN_OPTIONS.righttabs) WONDERPLUGIN_SLIDER_SKIN_OPTIONS.lefttabs[key] = WONDERPLUGIN_SLIDER_SKIN_OPTIONS.righttabs[key];
WONDERPLUGIN_SLIDER_SKIN_OPTIONS.lefttabs.navposition = "left";
WONDERPLUGIN_SLIDER_SKIN_OPTIONS.lefttabs.navmarginx = -240;
var WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS = {
    ...
    "Left box": {
        ...
        "textcss": "display:block; padding:12px; text-align:left;",
        "textbgcss": "display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background-color:#333333; opacity:0.6; filter:alpha(opacity=60);",
        "titlecss": 'display:block; position:relative; font:bold 24px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#fff; padding:12px;',
        "descriptioncss": 'display:block; position:relative; font:16px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#fff; padding:12px;',
    ...
    "Red title": {
        ...
        "textcss": "display:block; padding:8px 16px; text-align:left;",
        "textbgcss": "display:none;",
        "titlecss": 'display:table; position:relative; font:24px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#e04000; white-space:nowrap;',
        "descriptioncss": 'display:block; position:relative; font:12px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#fff;  background-color:#e04000; margin-top:10px; padding:10px;',
        "buttoncss": "display:block; position:relative; margin-top:10px;",
        "texteffectresponsive": true,
        "texteffectresponsivesize": 640,
    ...
    "White title": {
        ...
        "textcss": "display:block; padding:8px 16px; text-align:left;",
        "textbgcss": "display:none;",
        "titlecss": 'display:table; position:relative; font:24px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#fff; white-space:nowrap;',
    ...
    "Yellow title": {
        ...
        "textcss": "display:block; padding:8px 16px; text-align:left;",
        "textbgcss": "display:none;",
        "titlecss": 'display:table; position:relative; font:24px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#f7a020; white-space:nowrap;',
